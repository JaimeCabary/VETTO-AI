...
//                         height: 140,
//                         child: SvgPicture.asset(
//                           'assets/images/undraw_powerful_e1sw.svg',
//                           fit: BoxFit.contain,
//                         ),
//                       ),
//                     ),
            ...
            child: FadeTransition(
              ...
              child: SlideTransition(
                ...
                child: ColorFiltered(
                  ...
                  child: SizedBox(width: 65, height: 65, child: SvgPicture.asset('assets/images/undraw_join_6quk.svg', fit: BoxFit.contain)),
                ),
              ),
            ),
          ),
          Positioned(
            ...
            child: FadeTransition(
              ...
              child: SlideTransition(
                ...
                child: ColorFiltered(
                  colorFilter: ColorFilter.mode(Colors.white.withValues(alpha: 0.4), BlendMode.modulate),
                  child: SizedBox(width: 70, height: 70, child: SvgPicture.asset('assets/images/undraw_online-community_3o0l.svg', fit: BoxFit.contain)),
                ),
              ),
            ),
          ),
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                ScaleTransition(
                  scale: _mainImageAnimation,
                  child: SizedBox(width: 190, height: 140, child: SvgPicture.asset('assets/images/undraw_powerful_e1sw.svg', fit: BoxFit.contain)),
                ),
                const SizedBox(height: AppConstants.spacingXL),
                const Text('Ready to Begin?', style: TextStyle(fontSize: AppConstants.fontSizeXXL, fontWeight: FontWeight.w800, color: Colors.white, height: 1.2), textAlign: TextAlign.center),
                const SizedBox(height: AppConstants.spacingL),
                const Text('Join thousands of users building the future today. Start creating amazing workflows, websites, and AI-powered solutions.', style: TextStyle(fontSize: AppConstants.fontSizeL, color: Colors.white, height: 1.5), textAlign: TextAlign.center),
                const SizedBox(height: AppConstants.spacingXL),
                FadeTransition(
                  opacity: _featureAnimation,
                  child: Column(
