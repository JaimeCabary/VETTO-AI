...
class _SplashScreenState extends State<SplashScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // 1. Set Status Bar to Dark (since background is light)
                    ...
                    child: ScaleTransition(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // 2. MAIN APP NAME (ADDED HERE)
                          const Text(
                            "Uruella AI",
                            style: TextStyle(
                              fontSize: 32,
                              fontWeight: FontWeight.w900,
                              color: Color(0xFF1A1A1A), // Jet Black
                              letterSpacing: 2.0,
                            ),
                          ),
                          ...
                          const Text(
                            ...
                            style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w600,
                              color: Color(0xFF6A7B66), // Sage Olive Accent
                              letterSpacing: 4.0,
                            ),
                          ),
                          ...
                          const SizedBox(
                            ...
                            child: CircularProgressIndicator(
                              strokeWidth: 2.5,
                              valueColor: AlwaysStoppedAnimation(Color(0xFF6A7B66)),
                            ),
                          ),
                        ],
                      ),
