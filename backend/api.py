...
import asyncio
import re
import json # Ensure this is imported for the streaming response
...
# Add Middleware to allow communication from Flutter (needed for local testing)
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
    allow_methods=["*"],
...
# 2. CORE STREAMING COMMAND ENDPOINT (Simulates the local FFI Llama call)
...
async def stream_command(
    ...
    """
    Simulates the real-time, word-by-word typing response Uruella will use.
    """
